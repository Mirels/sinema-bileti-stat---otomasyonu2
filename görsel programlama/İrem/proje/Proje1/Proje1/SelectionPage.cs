...
namespace Proje1
{
    ...
    public partial class SelectionPage : Form
    {
        ...
        private void btnBuy_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("İSİM GİRNİZ","Sistem Mesajı", MessageBoxButtons.OK);
            ...
            if (chairs.Count == 0)
            {
                MessageBox.Show("LÜTFEN KOLTUK SEÇİMİNİZİ YAPINIZ", "Sistem Mesajı", MessageBoxButtons.OK);
                return;
            }
